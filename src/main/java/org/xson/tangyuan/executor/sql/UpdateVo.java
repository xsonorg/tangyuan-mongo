...
public class UpdateVo implements SqlVo {
	...
	public int update(DBCollection collection) {
		...
		WriteResult result = collection.update(query, update, false, true, TangYuanMongoContainer.getInstance().getDefaultWriteConcern());
